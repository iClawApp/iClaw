...
function buildReviewPrompt(opts: {
  ...
  return [
    ...
    '',
    'The "description" is read by a NON-TECHNICAL person on a save prompt (and also',
    'helps the agent pick this skill later). Write it as ONE short, plain sentence',
    'in everyday words: name the real-world situation and what it achieves. Avoid',
    'jargon — no "sandbox", "runtime", "container", "API", "stdout", "kebab", CLI',
    'flags, or file paths. Concrete and friendly, not a technical summary.',
    'Good: "How to finish a task on your own computer when the safe workspace has',
    'no internet." Bad: "Provides code to run locally when sandbox network is',
    'restricted." Keep the procedure detail in "body", not the description.',
    '',
    'OUTPUT: strict JSON, no prose, no code fences:',
    '{"skills":[{"action":"new"|"patch","target":"<existing-name, patch only>",',
    '"name":"<kebab-case>","description":"<one plain-language sentence, no jargon>","tags":["..."],',
